VERSION 5.00
Begin VB.Form frmAutoExportInfocentre 
   ...
   End
End
Attribute VB_Name = "frmAutoExportInfocentre"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Attribute VB_Ext_KEY = "RVB_UniqueId" ,"5C8A6843032F"

Option Explicit

'##ModelId=5C8A6844006F
Public frmTypeProvision As Integer
'##ModelId=5C8A6844008F
Public frmDelExistant As Boolean
'##ModelId=5C8A684400AE
Public frmCreateSignalisation As Boolean
'

'##ModelId=5C8A684400CD
Private Sub btnForceTop_Click()
  CreationFichierSignalisation
End Sub

'##ModelId=5C8A684400DD
Private Sub CancelButton_Click()
  'ret_code = -1
  Unload Me
End Sub

'##ModelId=5C8A684400EC
Private Sub Form_Load()
  rdoDelExistant.Value = True
  rdoBilan.Value = True
  
  'we have potentially several periods with possibly different types - so, we don't pass in a paramter that specifies the type
...
Private Sub OKButton_Click()
  ...
  'we have potentially several periods with possibly different types - so, we don't perform this test
